...
const val SHOW_ALL_NEIGHBOR_DISCOVERY_REQUESTS = "show_all_neighbor_discovery_requests"
...
class AdvancedSettings : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val showAllNeighborDiscoveryRequestsSwitch =
            findViewById<SwitchCompat>(R.id.showAllNeighborDiscoveryRequestsSwitch)
        ...
        val showAllNeighborDiscoveryRequestsPrefs = advancedPrefs.getBoolean(
        ...
        showAllNeighborDiscoveryRequestsSwitch.isChecked = showAllNeighborDiscoveryRequestsPrefs
        ...
        setSwitchListener(
            showAllNeighborDiscoveryRequestsSwitch,
            SHOW_ALL_NEIGHBOR_DISCOVERY_REQUESTS
        )
